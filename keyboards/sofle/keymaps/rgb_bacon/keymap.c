...
#define KC_QWERTYDEUX PDF(_QWERTYDEUX)
#define KC_COLEMAKDH PDF(_COLEMAKDH)
#define KC_GAME PDF(_GAMING)
...
[_QWERTY] = LAYOUT(
  ...
  //|-----+--------+--------+--------+--------+--------|  ====  |   |  ====  |--------+--------+--------+--------+--------+--------|
                 KC_LCTL, KC_LALT, KC_LGUI, KC_ENT,  KC_LOWER,          KC_RAISE,KC_SPC,  KC_RCTL, KC_RALT, TG(7)
  //            \--------+--------+--------+--------+--------|         |--------+--------+--------+--------+--------/
),
[_QWERTYDEUX] = LAYOUT(
  //,--------------------------------------------------.                     ,-----------------------------------------------------.
  ...
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_MUTE,     KC_MPLY, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
  //|-----+--------+--------+--------+--------+--------|  ====  |   |  ====  |--------+--------+--------+--------+--------+--------|
                 KC_LCTL, KC_LALT, KC_LGUI, KC_ENT,  KC_LOWER,          KC_RAISE,KC_SPC,  KC_RCTL, KC_RALT, _______
  //            \--------+--------+--------+--------+--------|         |--------+--------+--------+--------+--------/
),
[_COLEMAKDH] = LAYOUT(
  //,--------------------------------------------------.                     ,-----------------------------------------------------.
...
[_GAMING] = LAYOUT(
  ...
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_MUTE,     KC_MPLY, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
  //|-----+--------+--------+--------+--------+--------|  ====  |   |  ====  |--------+--------+--------+--------+--------+--------|
                 KC_QUOT, KC_LALT, KC_LCTL, KC_SPC,  KC_LOWER,          KC_RAISE, KC_ENT, KC_LGUI, KC_RALT, TG(7)
  //            \--------+--------+--------+--------+--------|         |--------+--------+--------+--------+--------/
),
[_LOWER] = LAYOUT(
  //,--------------------------------------------------.                     ,-----------------------------------------------------.
  ...
  //|-----+--------+--------+--------+--------+--------|  ====  |   |  ====  |--------+--------+--------+--------+--------+--------|
                 _______, _______, _______, KC_SPC,  _______,           _______, _______, _______, _______, TO(8)
  //            \--------+--------+--------+--------+--------|         |--------+--------+--------+--------+--------/
),
[_RAISE] = LAYOUT(
  //,--------------------------------------------------.                     ,-----------------------------------------------------.
  KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                         KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,
  //|-----+--------+--------+--------+--------+--------|                     |--------+--------+--------+--------+--------+--------|
  _______, KC_INS,  KC_PSCR, XXXXXXX, XXXXXXX, XXXXXXX,                       KC_F12,  KC_AMPR, KC_LPRN, KC_RPRN, XXXXXXX, KC_DEL,
  //|-----+--------+--------+--------+--------+--------|                     |--------+--------+--------+--------+--------+--------|
  _______, KC_LALT, KC_LCTL, XXXXXXX, XXXXXXX, XXXXXXX,                       KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, XXXXXXX, XXXXXXX,
  //|-----+--------+--------+--------+--------+--------|  ====  |   |  ====  |--------+--------+--------+--------+--------+--------|
...
[_ADJUST] = LAYOUT(
  ...
  //|-----+--------+--------+--------+--------+--------|                     |--------+--------+--------+--------+--------+--------|
  KC_NUM,  KC_QWERTY,KC_QWERTYDEUX,KC_COLEMAKDH, XXXXXXX, XXXXXXX,               XXXXXXX, XXXXXXX, KC_BRIU, XXXXXXX, XXXXXXX, QK_BOOT,
  //|-----+--------+--------+--------+--------+--------|                     |--------+--------+--------+--------+--------+--------|
  KC_CAPS, UG_TOGG, UG_HUEU, UG_SATU, UG_VALU,  KC_GAME,                       XXXXXXX, XXXXXXX, KC_BRID, XXXXXXX, XXXXXXX, EE_CLR,
  //|-----+--------+--------+--------+--------+--------|  ====  |   |  ====  |--------+--------+--------+--------+--------+--------|
  KC_SCRL, UG_NEXT, UG_HUED, UG_SATD, UG_VALD,  XXXXXXX, XXXXXXX,    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  //|-----+--------+--------+--------+--------+--------|  ====  |   |  ====  |--------+--------+--------+--------+--------+--------|
...
[_NUMPAD] = LAYOUT(
  //,--------------------------------------------------.                     ,-----------------------------------------------------.
  KC_ESC,  _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                       XXXXXXX, KC_NUM,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  //|-----+--------+--------+--------+--------+--------|                     |--------+--------+--------+--------+--------+--------|
  KC_TAB,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                       KC_CIRC, KC_P7,   KC_P8,   KC_P9,   KC_ASTR, KC_BSPC,
  //|-----+--------+--------+--------+--------+--------|                     |--------+--------+--------+--------+--------+--------|
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                       KC_MINS, KC_P4,   KC_P5,   KC_P6,   KC_EQL,  KC_PIPE,
  //|-----+--------+--------+--------+--------+--------|  ====  |   |  ====  |--------+--------+--------+--------+--------+--------|
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,     DB_TOGG, KC_PLUS, KC_P1,   KC_P2,   KC_P3,   KC_SLSH, _______,
  //|-----+--------+--------+--------+--------+--------|  ====  |   |  ====  |--------+--------+--------+--------+--------+--------|
...
static void render_logo(void) {
    static const char PROGMEM bacon_logo[] = {
...
static void print_status_narrow(void) {
    static const char PROGMEM header[] = {
        0x9C, 0x9C, 0x9C, 0x9D, 0x20, 0x0A,
        0xBA, 0xBB, 0xBC, 0xBD, 0xBE, 0x00
    };

    static const char PROGMEM sep1[] = {
        0xDA, 0xDB, 0xDC, 0xDD, 0xDE, 0x00
    };
    static const char PROGMEM sep2[] = {
        0xFA, 0xFB, 0xFC, 0xFD, 0xFE, 0x00
    };

    // Print current mode
    oled_write_P(header, false);
    oled_write_P(sep1, false);
    ...
    switch (get_highest_layer(default_layer_state)) {
        case _QWERTY:
            ...
            break;
        case _QWERTYDEUX:
            oled_write_ln_P(PSTR("QDeux"), false);
            break;
        case _COLEMAKDH:
    ...
    static const char PROGMEM led_off[] = {
        0x5F, 0x00
    };

    static const char PROGMEM led_on[] = {
        0xD6, 0x00
    };

    oled_write_ln_P(PSTR("\n\n"), false);
    oled_write_ln_P(PSTR("C N S"), false);

    led_t led_state = host_keyboard_led_state();
    oled_write_P(led_state.caps_lock ? led_on : led_off, false);
    oled_write_P(PSTR(" "), false);
    oled_write_P(led_state.num_lock ? led_on : led_off, false);
    oled_write_P(PSTR(" "), false);
    oled_write_P(led_state.scroll_lock ? led_on : led_off, false);
}
